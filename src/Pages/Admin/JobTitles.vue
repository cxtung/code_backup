      ...
      <div class="modal-content">
        ...
        <div class="form-group">
          <label for="JobDescription"
            >Job Description<span class="required">*</span></label
          >
          <input
        ...
        <div class="form-group">
          <label for="name"
            >Job Specification<span class="required">*</span></label
          >
          <input
            ...
            class="form-input"
          />
          <p style="font-size: 12px; margin-top: 10px">Accepts up to 1MB</p>
        </div>

        <div class="form-group">
          <label for="name"> Note<span class="required">*</span></label>
          <input
